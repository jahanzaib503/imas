...
@section('content')
    ...
    <section class="inner_sections">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('public/assets/images/inner-images/seafarers1.webp') }}" alt="" class="img-fluid wow fadeInRight" data-wow-duration="2s">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="inner_sections">
        <div class="container">
            <div class="row col_reverse">
                <div class="col-lg-6">
                    <img src="{{ asset('public/assets/images/inner-images/seafarers2.webp') }}" alt="" class="img-fluid wow fadeInLeft" data-wow-duration="2s">
                </div>
                <div class="col-lg-6">
    ...
    <section class="inner_sections">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('public/assets/images/inner-images/seafarers3.webp') }}" alt="" class="img-fluid wow fadeInRight" data-wow-duration="2s">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="inner_sections">
        <div class="container">
            <div class="row col_reverse">
                <div class="col-lg-6">
                    <img src="{{ asset('public/assets/images/inner-images/seafarers4.webp') }}" alt="" class="img-fluid wow fadeInLeft" data-wow-duration="2s">
                </div>
                <div class="col-lg-6">
                    <div class="content wow fadeInRight" data-wow-duration="1s">
                        <h2 class="heading">

...
@section('content')
    <section class="inner_banner" style="background-image: url('{{ asset('assets/images/banner/ambulance-driver-medical.jpg') }}')">
        <div class="container">
            ...
            <div class="clearfix">
                <div class="text">
                    ...
                    <p class="cta_para wow fadeInUp" data-wow-duration="3s">
                        Don’t let delays or long waiting lists hinder your career at sea. Contact Medicals Northwest to book your Seafarers Medical Assessment and ensure you’re fit for duty. Your health and safety are our top priorities.
                    </p>
                </div>

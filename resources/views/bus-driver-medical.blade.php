...
@section('content')
    <section class="inner_banner"
        style="background-image: url('{{ asset('public/assets/images/banner/bus-driver-medical.webp') }}')">
        <div class="container">
    ...
    <section class="inner_sections">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('public/assets/images/inner-images/bus1.webp') }}" alt=""
    ...
    <section class="inner_sections">
        <div class="container">
            <div class="row col_reverse">
                <div class="col-lg-6">
                    <img src="{{ asset('public/assets/images/inner-images/bus2.webp') }}" alt=""
